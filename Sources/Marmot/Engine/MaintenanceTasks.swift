    ...
    static var all: [MaintenanceTask] {
        [
            ...
            MaintenanceTask(
                ...
                commands: [("atsutil databases -remove", true)],
                risk: .medium),
            MaintenanceTask(
            ...
            MaintenanceTask(
                ...
                commands: [
                    ("rm -rf ~/Library/Logs/DiagnosticReports/*", false),
            ...
            MaintenanceTask(
                ...
                commands: [("periodic daily weekly monthly", true)],
                risk: .low)
        ]
    }
}
